  ...
  return (
    <div>
          <div style={{textAlign:'center'}}>
            <h1 style={{fontFamily: "sans-serif",fontSize: "40px", fontWeight: "700", marginTop: "30px", paddingBottom:"20px", textAlign:'center'}}>About Us</h1>
           ...
           <h1 style={{fontFamily: "sans-serif",fontSize: "40px", fontWeight: "700", marginTop: "30px", paddingBottom:"20px",textAlign:'center'}}>Our Story</h1>

          <div style={{position: "relative", marginTop: "40px"}}>
            <div style={{width: "70%", margin: "auto", }}>
            <img  style={{borderRadius: "20px",width: "100%", height: "400px"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHK-H1QPryLikTosCk9FcxxwydbDEcvtnsxg&usqp=CAU" alt="" />
            </div>
          ...
          <div style={{position: "relative", marginTop: "200px"}}>
            <div style={{width: "70%", margin: "auto", }}>
            <img  style={{borderRadius: "20px",width: "100%", height: "400px"}} src="https://thumbs.dreamstime.com/b/online-courses-banner-flat-style-workspace-laptop-books-lamp-coffee-e-learning-concept-distance-education-177644012.jpg" alt="" />
            </div>
            <div style={{boxShadow: "rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px",borderRadius: "20px",width: "55%", margin: "auto", position: "absolute", marginLeft: "340px",bottom: "-110px", backgroundColor: "white"}}>
              <div style={{width: "70%", margin: "auto", paddingLeft: "30px", paddingRight: "30px",paddingTop: "40px",paddingBottom: "40px"}}>
              <h1 style={{ fontFamily: "sans-serif",lineHeight: "35px", fontSize: "17px", color: "grey" }}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est eligendi explicabo reprehenderit,
          ...
          <div style={{position: "relative", marginTop: "200px"}}>
            <div style={{width: "70%", margin: "auto", }}>
            <img  style={{borderRadius: "20px",width: "100%", height: "400px"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMSjrq5gaHe-ikshFGtqAKBeIuWE9b14T15A&usqp=CAU" alt="" />
            </div>
            <div style={{boxShadow: "rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px",borderRadius: "20px",width: "55%", margin: "auto", position: "absolute", marginLeft: "340px",bottom: "-110px", backgroundColor: "white"}}>
              <div style={{width: "70%", margin: "auto", paddingLeft: "30px", paddingRight: "30px",paddingTop: "40px",paddingBottom: "40px"}}>
              <h1 style={{ fontFamily: "sans-serif",lineHeight: "35px", fontSize: "17px", color: "grey" }}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est eligendi explicabo reprehenderit,
          ...
          <div style={{border: "1px solid black", width: "70%", height: "300px", marginTop: "200px", position: "relative", marginLeft: "15%"}}>
            <img style={{width: "100%", height: "300px"}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRleDSIs8hnIiR5LSte7h2M4SYObNZpDZSkGg&usqp=CAU" alt="" />
           ...
           <div style={{width: "55%", margin: "auto", position: "absolute", marginLeft: "250px",bottom: "220px",}}>
              ...
              <h1 style={{ fontFamily: "sans-serif",lineHeight: "35px", fontSize: "30px", color: "grey" }}><span style={{color: "red"}}>Subscribe</span> <span style={{color: "black"}}>And Be</span> <span style={{color: "red"}}>Updated</span> </h1>
              </div>
